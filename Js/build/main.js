...
var gameObject = new _csharp.UnityEngine.GameObject("testobject");
console.log(gameObject.name);
gameObject.transform.position = new _csharp.UnityEngine.Vector3(1, 2, 3); // const CS = require('csharp');
// import './src/index.js'
